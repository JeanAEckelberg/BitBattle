...
- As a [Competition Artist](./Actors.md#competition-artist), I want an easy, clear interface, so that I can make and upload art without worrying about the internal behavior of the [engine](../Definitions.md#engine).
- As a [Competition Artist](./Actors.md#competition-artist), I want to have minimal interaction with the [engine](../Definitions.md#engine), so that I can focus on the art, interface, and layout.
...
- As a [Competition Developer](./Actors.md#competition-developer), I want support for multiple [game](../Definitions.md#game) types (co-op, turn-based, etc), so that I can create the style of [game](../Definitions.md#game) that I want.
...
- As a [Spectator](./Actors.md#spectator), I want to navigate [matches](../Definitions.md#match) so that I can find [match](../Definitions.md#match) metadata and [replays](../Definitions.md#replay) I care about.

- As a [Spectator](./Actors.md#spectator), I want to view previous [matches](../Definitions.md#match), so that I can see how [competitor](./Actors.md#competitor)s' [bots](../Definitions.md#bot) have changed and developed over time.
